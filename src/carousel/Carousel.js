...
export default class Carousel extends Component {
  ...
  _getWrappedRef() {
    ...
    return this._carouselRef.getNode && this._carouselRef.getNode();
  }
  ...
  _renderItem({ item, index }) {
    ...
    return (
      <Component style={[mainDimension, slideStyle, animatedStyle]} pointerEvents={"box-none"} key={specificProps.key}>
  ...
  _getComponentOverridableProps() {
    const { enableMomentum, itemWidth, itemHeight, loopClonesPerSide, sliderWidth, sliderHeight, vertical } =
      this.props;
